...
%>
      ...
      <div class = "bottomMenu">
	    ...
	    <table width="75%" align="center" bgcolor="#000000">
	  <tr bgcolor="#EFF8FB"> 
	    <td align="center"><b><a href="../layout.jsp" target="_blank">사이트 홈 </a></b></td>
	     <td align="center"><b><a href="Admin_index.jsp">관리자 홈 </a></b></td>
	    <td align="center"><b><a href="#">관리자 로그아웃 </a></b></td>
	    <td align="center"><b><a href="Admin_MemberMgr.jsp">회원 관리 </a></b></td>
	    <td align="center"><b><a href="Admin_ProductMgr.jsp">상품 관리 </a></b></td>
	    <td align="center"><b><a href="#">주문 관리</a></b></td>
	  </tr>
	</table> 
